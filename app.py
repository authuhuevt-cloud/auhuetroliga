...
<div class="main-header">
    ...
    <p>Tác giả: Ấu Thị Huế - Trường tiểu học Vĩnh Thành - ĐT: 0397751867</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ấu Thị Huế - Trường tiểu học Vĩnh Thành - ĐT: 0397751867</div>", unsafe_allow_html=True)
